...
class User_own extends SessionController{
    ...
    function render(){
        ...
        $this->view->render('usu_owner/index');
    ...
    function getPersonaById(){
        $user = new UserModel();
        echo json_encode($user->getPersonById($this->user->getusu_cod()));
    }
    function getRol(){
        $user = new UserModel();
    ...
    function updatePersona(){
        $user = new UserModel();
        $id = $this->getPost('per_email');
        $nombre = $this->getPost('per_direccion');
        echo json_encode($user->updatePersona($id,$nombre,$this->user->getusu_cod()));
    }
    ...
    function updatePassword(){
        ...
        $newHash = $user->comparePasswords($current, $this->user->getusu_cod());
        if($newHash){
    ...
    //             $this->model->updatePhoto($hash, $this->user->getusu_cod());
